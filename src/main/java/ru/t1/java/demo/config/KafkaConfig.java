...
public class KafkaConfig {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, TransactionDto> kafkaTransactionListenerContainerFactory(@Qualifier("transactionConsumerFactory") ConsumerFactory<String, TransactionDto> consumerFactory) {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, AccountDto> kafkaAccountListenerContainerFactory(@Qualifier("accountConsumerFactory") ConsumerFactory<String, AccountDto> consumerFactory) {
